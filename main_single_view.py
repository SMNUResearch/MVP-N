...
from loss import LabelCrossEntropy, KDLoss, SoftBootstrapping, HardBootstrapping
from loss import LabelSmoothing, BetaMixture, DynamicBootstrapping, LikelihoodRatioTest
from loss import SelfAdaptiveTraining, ProgressiveLabelCorrection, OnlineLabelSmoothing
